				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="card-overlay style-1 bg-primary"><a href="/item-details-pizza">
							<div class="dz-media">
								<img src="img/products/featured/pic1.png" alt=""/>
							</div>
							<div class="dz-info">
					...
					<div class="swiper-slide">
						<div class="card-overlay style-1 bg-primary"><a href="/item-details-tea">
							<div class="dz-media">
								<img src="img/products/featured/pic2.png" alt=""/>
							</div>
							<div class="dz-info">
					...
					<div class="swiper-slide">
						<div class="card-overlay style-1 bg-primary"><a href="/item-details-kfc">
							<div class="dz-media">
								<img src="img/products/featured/pic3.png" alt=""/>
							</div>
							<div class="dz-info">
					...
					<div class="swiper-slide">
						<div class="card-overlay style-1 bg-primary"><a href="/item-details-tylenol">
							<div class="dz-media">
								<img src="img/products/featured/pic4.png" alt=""/>
							</div>
							<div class="dz-info">
					...
					<div class="swiper-slide">
						<div class="card-overlay style-1 bg-primary"><a href="/item-details-bon">
							<div class="dz-media">
								<img src="img/products/featured/pic5.png" alt=""/>
							</div>
							<div class="dz-info">
				...
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<div class="categories-bx">
							...
							<div class="dz-content">
								<h5 class="title"><a href="/products/">Cafe</h5>
					...
					<div class="swiper-slide">
						<div class="categories-bx">
							...
							<div class="dz-content">
								<h5 class="title"><a href="/products/">Farmacia</h5>
					...
					<div class="swiper-slide">
						<div class="categories-bx">
							...
							<div class="dz-content">
								<h5 class="title"><a href="/products/">Pizza</h5>
					...
					<div class="swiper-slide">
						<div class="categories-bx">
							...
							<div class="dz-content">
								<h5 class="title"><a href="/products/">Alcohol</h5>
					...
					<div class="swiper-slide">
						<div class="categories-bx">
							...
							<div class="dz-content">
								<h5 class="title"><a href="/products/">Cafeterias</h5>
								<span class="menus text-primary">67 Menus</span>
							</div>
						</div>
					</div>
					<div class="swiper-slide">
						<div class="categories-bx">
							...
							<div class="dz-content">
								<h5 class="title"><a href="/products/">Burger</h5>
