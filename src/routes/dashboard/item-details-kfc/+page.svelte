	...
	<div class="page light">
		...
		<div class="page-content item-details pt-0 pb-0">
			...
			<div class="dz-banner-heading bg-primary">
				<img src="img/products/single/pic3.png" class="bnr-img" alt=""/>
			</div>
			...
			<div class="fixed-content container">
				<div class="clearfix">
					<h3 class="ma-0">KFC Combo Familia</h3>
					<p>Suficiente KFC Pica Pollo pa Todo la Familia</p>
				</div>
				<div class="item-rating">3.8</div>
				<div class="dz-range">
				...
				<div class="price-bx">
					<h2 class="price"><sup>$</sup>750 <del>$1220</del></h2>
				...
				<a href="/checkout-payment-method/" class="button-large button rounded-xl button-fill">Hacer Orden <span>$750</span></a>
