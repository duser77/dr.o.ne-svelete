...
<div class="page">
	...
	<div class="page-content content-area pt-90">
		...
		<!-- Products -->
		<div class="container">
			<div data-space-between="0" data-slides-per-view="auto" data-centered-slides="false" class="swiper swiper-init tabbar tab-style-2">
				<div class="swiper-wrapper">
					<div class="swiper-slide">
						<a href="#tab-1" class="tab-link tab-link-active">Helados</a>
					</div>
					<div class="swiper-slide">
						<a href="#tab-2" class="tab-link">Farmacia</a>
					</div>
					<div class="swiper-slide">
						<a href="#tab-3" class="tab-link">Fast Food</a>
					</div>
					<div class="swiper-slide">
						<a href="#tab-4" class="tab-link">Bebidas</a>
					</div>
				</div>
			</div>
			<div class="list simple-list searchbar-not-found">
						...
						<ul class="row">
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="img/products/productbon.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 3.4</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
											<h6 class="item-title"><a href="/item-details/">BON Yogurt Congelada</a></h6>
											<ul class="tag-list">
										...
										<div class="dz-meta">
											<ul>
												<li class="price">$275</li>
												<li><a href="/item-details/" class="button btn-buy">
													<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="img/products/productbrownie.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 3.8</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
											<h6 class="item-title"><a href="/item-details/">Brownie Americano con Helado Vanilla</a></h6>
											<ul class="tag-list">
												<li><a href="#">Postre</a></li>
											</ul>
										</div>
							...
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="img/products/productcake.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 3.8</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
											<h6 class="item-title"><a href="/item-details/">Biscoche</a></h6>
											<ul class="tag-list">
												<li><a href="#">Postre</a></li>
											</ul>
										</div>
							...
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="img/products/productpops.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 3.8</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
											<h6 class="item-title"><a href="/item-details/">Dulces Individuales</a></h6>
											<ul class="tag-list">
					...
					<div class="list search-list mt-0 mb-20 container searchbar-found item-list">
						<ul class="row">
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="img/products/producttylenol.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 3.8</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
											<h6 class="item-title"><a href="/item-details/">Tylenol Ultra</a></h6>
											<ul class="tag-list">
							...
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="img/products/productd3.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 3.8</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
											<h6 class="item-title"><a href="/item-details/">Vitamina D3 + Calcio</a></h6>
											<ul class="tag-list">
												<li><a href="#">Vitamina</a></li>
											</ul>
										</div>
										<div class="dz-meta">
											<ul>
							...
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="img/products/productgum.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 4.1</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
											<h6 class="item-title"><a href="/item-details/">Vitamina Completa - Gomitos</a></h6>
											<ul class="tag-list">
							...
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="img/products/productnyquil.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 3.8</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
											<h6 class="item-title"><a href="/item-details/">NyQuil</a></h6>
											<ul class="tag-list">
					...
					<div class="list search-list mt-0 mb-20 container searchbar-found item-list">
						<ul class="row">
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="img/products/producttaco.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 3.8</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
											<h6 class="item-title"><a href="/item-details/">Taco Bell Chalupa XXTREME</a></h6>
											<ul class="tag-list">
												<li><a href="#">Tacos</a></li>
												<li><a href="#">Queso</a></li>
											</ul>
										</div>
										<div class="dz-meta">
											<ul>
							...
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="img/products/productpop.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 3.3</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
											<h6 class="item-title"><a href="/item-details/">Popeyes Sandwich</a></h6>
											<ul class="tag-list">
							...
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="img/products/productmcD.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 4.9</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
											<h6 class="item-title"><a href="/item-details/">McDonalds Combo #1</a></h6>
											<ul class="tag-list">
							...
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="img/products/productWshake.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 3.8</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
											<h6 class="item-title"><a href="/item-details/">Wendys Milkshake</a></h6>
											<ul class="tag-list">
					...
					<div class="list search-list mt-0 mb-20 container searchbar-found item-list">
						<ul class="row">
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="img/products/producttea.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 3.8</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
							...
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="img/products/productstar.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 4.4</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
											<h6 class="item-title"><a href="/item-details/">Starbucks Espresso</a></h6>
											<ul class="tag-list">
												<li><a href="#">Cafe</a></li>
											</ul>
										</div>
							...
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="img/products/productagua.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 4.6</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
											<h6 class="item-title"><a href="/item-details/">Agua Dasani</a></h6>
											<ul class="tag-list">
							...
							<li class="col-100 medium-50">
								<div class="item-bx item-list">
									<div class="dz-media">
										<a href="/item-details/"><img src="img/products/productsoda.jpg" alt=""></a>
										<div class="rating"><i class="fa fa-star"></i> 3.1</div>
									</div>
									<div class="dz-info">
										<div class="dz-head">
											<h6 class="item-title"><a href="/item-details/">Biligue Refreko</a></h6>
											<ul class="tag-list">
												<li><a href="#">Soda</a></li>
											</ul>
										</div>
