...
<div class="page">
	...
	<div class="navbar navbar-style-1">
		<div class="navbar-inner">
			<a href="#" class="link back" on:click={()=>window.location.href='/blog'}>
			...
			<div class="title">Blog Detail</div>
            <div class="right">
	...
	<div class="page-content content-area">
		...
		<div class="container">
			<h3 class="sub-title">Nature's Ingredients</h3>
			<div class="blog-detail">
				<img src="img/products/coffee1.jpg" alt="/" />
				<p>
