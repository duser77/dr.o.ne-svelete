				...
				<div class="searchbar-inner">
					<div class="searchbar-input-wrap">
						...
						<i class="searchbar-icon">
							<svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
								<path fill-rule="evenodd" clip-rule="evenodd" d="M10.1839 0.0411987C4.55948 0.0411987 0 4.60068 0 10.2251C0 15.8496 4.55948 20.409 10.1839 20.409C15.8084 20.409 20.3678 15.8496 20.3678 10.2251C20.3678 4.60068 15.8084 0.0411987 10.1839 0.0411987ZM23.5803 23.5209C23.0136 24.0976 22.0815 24.1057 21.5048 23.5391L17.434 19.5391C18.2085 18.9354 18.9054 18.2372 19.5081 17.4619L23.5621 21.4454C24.1388 22.0121 24.147 22.9442 23.5803 23.5209ZM10.1839 2.87667C14.2424 2.87667 17.5323 6.16668 17.5323 10.2251C17.5323 14.2835 14.2423 17.5735 10.1839 17.5735C6.12548 17.5735 2.83552 14.2835 2.83552 10.2251C2.83552 6.16668 6.12553 2.87667 10.1839 2.87667Z" fill="#D5D5D5"/>
							</svg>
						</i>
					</div>
				</div>
			...
			<ul class="row">
				<li class="col-100 medium-50 mb-20">
					<div class="wishlist-bx">
						<div class="dz-media">
							<a href="/item-details/"><img src="img/menus/picrolex.jpg" alt=""></a>
						</div>
						<div class="dz-info">
							<div class="dz-head">
								<h6 class="item-title"><a href="/item-details/">Rolex Custom Watch</a></h6>
								<p>Variant : White Stripes</p>
							</div>
							<div class="dz-meta">
								<ul>
									<li class="price">$67,500</li>
									<li>
				...
				<li class="col-100 medium-50 mb-20">
					<div class="wishlist-bx">
						<div class="dz-media">
							<a href="/item-details/"><img src="img/menus/pickidney.jpg" alt=""></a>
						</div>
						<div class="dz-info">
							<div class="dz-head">
								<h6 class="item-title"><a href="/item-details/">Kidney Transplant</a></h6>
								<p>Emergency : Medical</p>
							</div>
							<div class="dz-meta">
								<ul>
									<li class="price">$35,000</li>
									<li>
										<label class="bookmark-btn">
											<input type="checkbox" checked>
											<span class="checkmark"></span>
				...
				<li class="col-100 medium-50 mb-20">
					<div class="wishlist-bx">
						<div class="dz-media">
							<a href="/item-details/"><img src="img/menus/picdoc.jpg" alt=""></a>
						</div>
						<div class="dz-info">
							<div class="dz-head">
								<h6 class="item-title"><a href="/item-details/">Document - Notarized</a></h6>
								<p>Privacy : Sensitive</p>
							</div>
							<div class="dz-meta">
								<ul>
				...
				<li class="col-100 medium-50 mb-20">
					<div class="wishlist-bx">
						<div class="dz-media">
							<a href="/item-details/"><img src="img/menus/picchange.jpg" alt=""></a>
						</div>
						<div class="dz-info">
							<div class="dz-head">
								<h6 class="item-title"><a href="/item-details/">Cambio Exacto</a></h6>
								<p>Credited : Previously</p>
							</div>
							<div class="dz-meta">
								<ul>
									<li class="price">$145</li>
									<li>
										<label class="bookmark-btn">
											<input type="checkbox" checked>
											<span class="checkmark"></span>
