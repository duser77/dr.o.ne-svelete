...
<script>
	const enableMap = ()=>{
		var mapIframe = document.querySelector('#mapbox iframe');
					var videoIframe = document.querySelector('#videobox iframe');
...
<div class="page location-tracking">
	<div class="navbar navbar-style-1" style="z-index:3">
	...
	<div class="page-content pt-0">
		...
		<!-- Map -->
		<div id="mapbox" style="display: block; height: 100vh; width: 100vw; z-index: -2; pointer-events: none;">
		<iframe src="https://www.google.com/maps/embed/v1/place?q=Santo+Domingo,+Dominican+Republic&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8" allowfullscreen="" loading="lazy"></iframe></div>

		<div id="videobox" style="display:none;height:100vh; width:100vw;z-index:-2; pointer-events: none;">
		<iframe src="https://www.youtube.com/embed/q9xpQjz2ACw" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
		</div>


		<div class="bottom-wraper" style="z-index:3">
			<div class="container track-content">
				<div class="map-dir">
					<p class="ma-0">Estimated Time</p>
					<h4 class="ma-0">5-10 min</h4>
					<button on:click={enableMap}
					
				  >Enable Map / Video</button>
				</div>
			</div>
			<div class="delivery-man container bg-primary">
				<div class="inner-content">
					...
					<div class="icon-area">
						<a class="item-link">
						<div class="icon-cell" on:click={iconCell}>
