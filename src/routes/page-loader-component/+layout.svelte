...
<template>
	<div class="page">
	  ...
	  <div class="page-content">
		...
		<div class="block block-strong">
		  <a href="#" class="button button-raised" >Open Alert</a>
		  <!-- @click=${openAlert} -->
		</div>
		...
		<div class="block block-strong">
		  ...
		  <div class="input ${$theme.md ? 'margin-bottom' : '' }">
			<input class="padding-bottom" type="text"  value=${name} placeholder="Type your name" />
			<!-- @input=${onInput} -->
		...
		<div class="block block-strong">
		  ...
		  <p><a class="button button-round button-fill" >Increase Counter</a></p>
		  <!-- @click=${onButtonClick} -->
		</div>
		${listItems && $h`
		...
		<div class="block block-strong">
		  ...
		  <ul style="padding-left:25px">
			...
			<li><a >$store.dispatch('helloWorld')</a></li>
			<!-- @click=${()=> $store.dispatch('helloWorld')} -->
		  </ul>
		</div>
