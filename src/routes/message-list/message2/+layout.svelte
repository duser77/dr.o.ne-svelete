	...
	<div class="page">
			...
			<div class="navbar navbar-style-1">
				<div class="navbar-inner">
					...
					<div class="title">Tracking Drone</div>
					<div class="right">
			...
			<div class="page-content pt-0">
				...
				<!-- Map -->
				<iframe src="https://www.google.com/maps/embed/v1/place?q=Santo+Domingo,+Dominican+Republic&key=AIzaSyBFw0Qbyq9zTFTd-tUY6dZWTgaQzuU17R8" allowfullscreen="" loading="lazy"></iframe>
					...
					<div class="fixed-content container">
						<ul class="track-list">
							<li>
								...
								<div class="info">
									<h5 class="title">Avenida Hernandez </h5>
									<p>P#LQ-R@HF Calle Maria Nina S.D.</p>
								</div>
							</li>
							<li>
								<div class="icon-bx">
								...
								<div class="info">
									<h5 class="title">Helados BON #41</h5>
