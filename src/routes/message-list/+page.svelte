...
<div class="page">
	...
	<div class="page-content pt-90 pb-30">
		...
		<div class="list media-list search-list searchbar-found search-list-bar container">
			<ul>
				<li>
					<a href="/messages/" class="item-link item-content">
						<div class="item-media">
							<img src="img/avatar/avatar1.jpg" alt="" width="50">
						</div>
						<div class="item-inner">
							<div class="item-title-row">
								<h5 class="item-title">Support - Gary</h5>
							</div>
							<p class="item-text">Hello William, Thankyou for your app</p>
				...
				<li>
					<a href="/messages/" class="item-link item-content">
						<div class="item-media">
							<img src="img/avatar/avatar2.jpg" alt="" width="50">
						</div>
						<div class="item-inner">
							<div class="item-title-row">
								<h5 class="item-title">Support - Dio</h5>
							</div>
							<p class="item-text">OK. Lorem ipsum dolor sect...</p>
							<div class="item-footer">
								<span class="item-time">2m ago</span>							
								<span class="item-info">Unread <i class="fa fa-check"></i></span>
							</div>
						</div>
					</a>
				</li>
				<li>
					<a href="/messages/" class="item-link item-content">
						<div class="item-media">
							<img src="img/avatar/avatar3.jpg" alt="" width="50">
							<div class="online"></div>
						</div>
						<div class="item-inner">
							<div class="item-title-row">
								<h5 class="item-title">Support - Systema</h5>
							</div>
							<p class="item-text">Tu orden #4857151 esta...</p>
							<div class="item-footer">
								<span class="item-time">2m ago</span>							
								<span class="item-info">Pending <i class="fa fa-check"></i></span>
							</div>
						</div>
					</a>
				</li>
				<li>
					<a href="/messages/" class="item-link item-content">
						<div class="item-media">
							<img src="img/avatar/avatar4.jpg" alt="" width="50">
							<div class="online"></div>
						</div>
						<div class="item-inner">
							<div class="item-title-row">
								<h5 class="item-title">Support - Kevin</h5>
							</div>
							<p class="item-text">Gracias por usar nuestro...</p>
							<div class="item-footer">
								<span class="item-time">2m ago</span>							
								<span class="item-info text-primary">Read <i class="fa fa-check"></i></span>
							</div>
						</div>
					</a>
				</li>
				<li>
					<a href="/messages/" class="item-link item-content">
						<div class="item-media">
							<img src="img/avatar/avatar5.jpg" alt="" width="50">
							<div class="online"></div>
						</div>
						<div class="item-inner">
							<div class="item-title-row">
								<h5 class="item-title">Support - Octavio</h5>
							</div>
							<p class="item-text">The reason for the wait...</p>
							<div class="item-footer">
								<span class="item-time">2m ago</span>							
								<span class="item-info text-primary">Read <i class="fa fa-check"></i></span>
							</div>
				...
				<li>
					<a href="/messages/" class="item-link item-content">
						<div class="item-media">
							<img src="img/avatar/avatar6.jpg" alt="" width="50">
							<div class="online"></div>
						</div>
						<div class="item-inner">
							<div class="item-title-row">
								<h5 class="item-title">Support - Claudia</h5>
							</div>
							<p class="item-text">Muchas gracias por tu...</p>
							<div class="item-footer">
								<span class="item-time">2m ago</span>							
								<span class="item-info">Unread <i class="fa fa-check"></i></span>
							</div>
				...
				<li>
					<a href="/messages/" class="item-link item-content">
						<div class="item-media">
							<img src="img/avatar/avatar7.jpg" alt="" width="50">
							<div class="online"></div>
						</div>
						<div class="item-inner">
							<div class="item-title-row">
								<h5 class="item-title">Support - Marcos</h5>
							</div>
							<p class="item-text">OK. I'll let them know...</p>
							<div class="item-footer">
								<span class="item-time">2m ago</span>							
								<span class="item-info">Pending <i class="fa fa-check"></i></span>
							</div>
