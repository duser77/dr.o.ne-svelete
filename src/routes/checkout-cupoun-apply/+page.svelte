	...
	<div class="page-content pt-60 bottom-sp80 checkout-details">
		<div class="sticky-top bg-white pb-20">
			<ul class="nav-wizard container">
				...
				<li>
					<a class="nav-link active" href="/checkout-coupon-apply/">
						<span>Coupon Apply</span>
					</a>
				</li>
				<li>
					<a class="nav-link" href="/checkout-payment-method/">
					...
					<ul class="row">
						<li class="item-content item-input col-100 item-input-with-value">
							<div class="item-inner">
								<div class="item-title item-label">Enter Coupon Code</div>
								<div class="item-input-wrap">
									<input type="text" placeholder="Code" value="#54856913215" class="form-control"/>
								</div>
							</div>
						</li>
					</ul>
